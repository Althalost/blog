...
<article {{ $attributes->merge(['class' => 'mb-8 bg-white shadow-lg rounded-lg relative overflow-hidden h-96 col-span-1 lg:col-span-1 dark:bg-gray-300 hover:shadow-gray-500/50']) }}>
    @if ($post->image)
    ...
    <div class="absolute right-2 top-2 rounded-lg bg-white bg-opacity-50 p-1 dark:bg-gray-500">
