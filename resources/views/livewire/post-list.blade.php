<div class="static grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 mb-10 md:mb-0 lg:mt-11 gap-6">
    @if ($this->posts->count())
        @foreach ($this->posts as $post)
            @if ($loop->first and $this->posts->onFirstPage() and $search == '' and $category_id == '')
