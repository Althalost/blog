...
<div class="pb-8 mb-11 mt-4">
    <div class="container mx-auto px-4">
        ...
        @auth
            <textarea 
                wire:model="comment"
                class="w-full p-4 text-sm text-gray-700 border-gray-200 rounded-lg bg-gray-50 focus:outline-none"
                name="" 
                id="" 
                cols="30" rows="7">
            </textarea>
        ...
        <div class="space-y-4 mt-5">
            ...
            @forelse ($this->comments as $comment)
                <div class="bg-gray-50 p-4 rounded shadow dark:bg-gray-300">
                <div class="flex items-center mb-2">
                    <img src="{{$comment->user->profile_photo_url}}" alt="User Avatar" class="w-10 h-10 rounded-full mr-3">
                    <div>
                    <h3 class="font-semibold text-gray-700">{{$comment->user->name}}</h3>
